...
<head>
  ...
  <title>BharatDarshan Admin Profile</title>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h3>${admindetails.designation}</h3>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">${admindetails.about}</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">${admindetails.designation}</div>
                  </div>
                  ...
                  <form action="adminupdateprofile" method="post" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="images/admin/profilephoto/${admindetails.profilephoto}">
                     </div>
                    </div>
