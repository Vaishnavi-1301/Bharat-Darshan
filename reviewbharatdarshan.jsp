...
<!-- Navbar & slider Start -->
  ...
  <aside id="sidebar" class="sidebar" style="margin-top:40px;background-color:#F6F9FF">
   ...
   <main id="main" class="main" style="margin-top:0px">
    ...
    <div class="pagetitle">
      <h1>Review Bharat Darshan</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admindashboard">Home</a></li>
          <li class="breadcrumb-item">User</li>
          <li class="breadcrumb-item active">Review Bharat Darshan</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-xl-12 col-md-12" >
            ...
            <div class="card-body pt-3">
                  <h2 class="text-center">Review <img src="Logo/Logo.png" alt="Logo"style="width:120px;height:50px"></h2>
                  
                  <form action="postreview" method="post">
                  	<input type="hidden" name="profilephoto" value="${userdetails.profilephoto}">
                    <input type="hidden" name="fullname" value="${userdetails.fullname}">
                    
                    
                    <div class="row">
                      <label for="review" class="col-md-12 col-lg-12 col-form-label">Write a Review:</label>
                      <div class="col-md-12 col-lg-12">
                        <textarea name="post" class="form-control" id="review"required="required" style="border-color:orange"></textarea>
                        <br>
                      </div>
                      
                      <label for="state" class="col-md-6 col-lg-2 col-form-label">Your State:</label>
                      <div class="col-md-6 col-lg-4">
                        <input name="state" type="text" class="form-control" id="state" required="required"style="border-color:orange">
                      </div>
                      <label for="city" class="col-md-6 col-lg-2 col-form-label">Your City:</label>
                      <div class="col-md-6 col-lg-4">
                        <input name="city" type="text" class="form-control" id="city" required="required"style="border-color:orange">
                     	<br>
                      </div>
                      <label for="date" class="col-md-6 col-lg-2 col-form-label">Todays Date:</label>
                      <div class="col-md-6 col-lg-4">
                        <input name="date" type="date" class="form-control" id="date" required="required"style="border-color:orange">
                     	<br>
                      </div>
                   </div>
                   <div class="text-center">
                   	  <button style="border-radius:10px;border-color:orange;padding:3px" type="submit">Post Review</button>
                    </div>
                  </form>
             </div>
       		 </div>
