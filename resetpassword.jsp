...
<div  class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="section-title bg-white text-center text-primary px-3">Enter New Password and Confirm It </h6>
        </div>
    </div>
</div>
            ...
            <div class="booking1 p-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        ...
                        <p class="mb-4">You Just Have To Enter Your New Password & Confirm Password. We Will Replace Your Old Password With New Password.
                        			And Remember Your Password For Future Use..
                        </p>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-floating text-white">
                                        <input type="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,16}$" name="password"class="form-control bg-transparent"required="required" id="password" placeholder="Enter New Password" oninvalid="this.setCustomValidity('Password should be minimum 8 characters includes atleast 1 uppercase,special character,numbers')"
                                ...
                                <div class="col-12">
                                    <button class="btn btn-outline-light w-100 py-3" type="submit" style="border-color:#FE8800;color:#FE8800">Reset Password</button>
                                </div>
