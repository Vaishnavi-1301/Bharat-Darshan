...
<head>
  ...
  <title>All BharatDarshan Users</title>
...
<!-- Navbar -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Bharat Darshan Users</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admindashboard">Home</a></li>
          <li class="breadcrumb-item">Admin</li>
          <li class="breadcrumb-item active">Bharat Darshan Users</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<div class="col-12">
  ...
  <c:forEach items="${userslist}" var="listitem">
    <tr>
      <td><img src="images/users/${listitem.profilephoto}"style="width:60px;height:60px;border-radius:100px "></td>
