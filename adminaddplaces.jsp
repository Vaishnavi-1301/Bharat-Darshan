    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Places</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section profile">
      <div class="row">
        <div class="col-xl-12 col-md-12 text-center">
				<h2>Existed <img src="Logo/Logo.png" alt="Logo" style="width:120px;height:40px"> Places</h2>
				<br>
				<a href="viewmodifyplaces"><button style="border-radius:10px;border-color:orange;padding:3px">View / Modify Places</button></a>
        ...
        <div class="col-xl-12 col-md-12">
          ...
          <div class="card" style="margin-top:20px;border-radius:20px">
            <div class="card-body pt-3">
              	<h2 class="text-center">Create A New <img src="Logo/Logo.png" alt="Logo" style="width:120px;height:40px"> Pilgrimage Place</h2>
				<br>
				...
				<form action="addplace" method="post"enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 col-lg-8">
                        <input name="pilgrimagename" type="text" class="form-control" id="Name" required="required"style="border-color:orange">
                    </div>
                    </div>
                    
                    <div class="row">
                      <label for="about" class="col-md-6 col-lg-2 col-form-label">About Pilgrimage Place</label>
                      <div class="col-md-6 col-lg-8">
                    ...
                    <div class="row mb-3">
                    <label for="location" class="col-md-6 col-lg-2 col-form-label">Pilgrimage Location</label>
                    <div class="col-md-6 col-lg-8">
                    ...
                    <div class="text-center">
                   	  <button style="border-radius:10px;border-color:orange;padding:3px" type="submit">Add Place</button>
                    </div>
